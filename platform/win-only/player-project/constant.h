...
{ //        type     number durability       mode      range         cd     damage     reduce      param      occur
    ...
    {    WEAPON,         4,        20,ITEM_MODE_SZ,       150,         2,        40,      0.00,      2.00,        35},    // ASSAULT_RIFLE
    {    WEAPON,         5,        50,ITEM_MODE_SZ,       100,         1,        40,      0.00,      3.00,        20},    // MACHINE_GUN
    {    WEAPON,         6,         8,ITEM_MODE_SZ,       600,         8,       100,      0.00,      0.50,        20},    // SNIPER_RILFE
    {    WEAPON,         7,         5,ITEM_MODE_SZ,      1000,        10,       150,      0.00,      0.30,        10},    // SNIPER_BARRETT
    {    WEAPON,         8,        20,ITEM_MODE_SZ,         2,         5,        50,      0.00,     60.00,        30},    // TIGER_BILLOW_HAMMER
    {    WEAPON,         9,        10,ITEM_MODE_SZ,       100,         6,        30,      0.00,      1.00,        25},    // CROSSBOW
    {     ARMOR,        10,       100,ITEM_MODE_SZ,         0,         0,         0,      0.15,      0.00,        50},    // VEST_1
    {     ARMOR,        11,       150,ITEM_MODE_SZ,         0,         0,         0,      0.25,      0.00,        25},    // VEST_2
    {     ARMOR,        12,       200,ITEM_MODE_SZ,         0,         0,         0,      0.30,      0.00,        10},    // VEST_3
    {     ARMOR,        13,       100,ITEM_MODE_SZ,         0,         0,         0,      0.50,      0.00,        30},    // INSULATED_CLOTHING
    {     GOODS,        14,         1,    PORTABLE,         0,         0,         0,      0.00,      0.30,        10},    // MUFFLER
...
{ //           shape                 type    x0    y0     r    x1    y2
    ...
    },    // city
    {
        ...
        {    CIRCLE,                TREE,    9,    5,    1,    0,    0},
        {    CIRCLE,                TREE,    3,   18,    1,    0,    0},
        {    CIRCLE,                TREE,    6,   45,    1,    0,    0},
        {    CIRCLE,                TREE,    4,   74,    1,    0,    0},
        {    CIRCLE,                TREE,   10,   95,    1,    0,    0},
        {    CIRCLE,                TREE,   85,   95,    1,    0,    0},
        {    CIRCLE,                TREE,   94,   85,    1,    0,    0},
        {    CIRCLE,                TREE,   85,   70,    1,    0,    0},
        {    CIRCLE,                TREE,   75,    5,    1,    0,    0},
        {    CIRCLE,                TREE,   95,   14,    1,    0,    0},
    ...
    },    // farmland
    {
        ...
        {    CIRCLE,                TREE,   50,   20,    1,    0,    0},
        {    CIRCLE,                TREE,   80,   50,    1,    0,    0},
        {    CIRCLE,                TREE,   70,    5,    1,    0,    0},
        {    CIRCLE,                TREE,   95,   25,    1,    0,    0},
        {    CIRCLE,                TREE,   10,   30,    1,    0,    0},
        {    CIRCLE,                TREE,   35,   65,    1,    0,    0},
        {    CIRCLE,                TREE,   15,   85,    1,    0,    0},
    ...
    },    // roadA
    {
        ...
        {    CIRCLE,                TREE,   20,   50,    1,    0,    0},
        {    CIRCLE,                TREE,   10,   20,    1,    0,    0},
        {    CIRCLE,                TREE,   75,    5,    1,    0,    0},
        {    CIRCLE,                TREE,   55,   20,    1,    0,    0},
        {    CIRCLE,                TREE,   90,   35,    1,    0,    0},
        {    CIRCLE,                TREE,   60,   60,    1,    0,    0},
        {    CIRCLE,                TREE,   75,   75,    1,    0,    0},
        {    CIRCLE,                TREE,   40,   90,    1,    0,    0},
    },    // roadB
    {
    ...
    {
        {    CIRCLE,                TREE,   26,   34,    1,    0,    0},
        {    CIRCLE,                TREE,   41,   50,    1,    0,    0},
        {    CIRCLE,                TREE,   67,   61,    1,    0,    0},
        {    CIRCLE,                TREE,   93,   82,    1,    0,    0},
        {    CIRCLE,                TREE,   81,   53,    1,    0,    0},
        {    CIRCLE,                TREE,   48,   20,    1,    0,    0},
        {    CIRCLE,                TREE,   76,    5,    1,    0,    0},
        {    CIRCLE,                TREE,   42,   43,    1,    0,    0},
        {    CIRCLE,                TREE,   97,   97,    1,    0,    0},
        {    CIRCLE,                TREE,   86,   70,    1,    0,    0},
        {    CIRCLE,                TREE,   39,   73,    1,    0,    0},
        {    CIRCLE,                TREE,   45,   35,    1,    0,    0},
        {    CIRCLE,                TREE,   23,   50,    1,    0,    0},
        {    CIRCLE,                TREE,   78,   56,    1,    0,    0},
        {    CIRCLE,                TREE,   88,   16,    1,    0,    0},
        {    CIRCLE,                TREE,   91,   56,    1,    0,    0},
        {    CIRCLE,                TREE,   56,   69,    1,    0,    0},
        {    CIRCLE,                TREE,   60,   43,    1,    0,    0},
        {    CIRCLE,                TREE,   15,   84,    1,    0,    0},
        {    CIRCLE,                TREE,   93,   74,    1,    0,    0},
        {    CIRCLE,                TREE,   48,   33,    1,    0,    0},
        {    CIRCLE,                TREE,   20,   45,    1,    0,    0},
        {    CIRCLE,                TREE,   90,   39,    1,    0,    0},
        {    CIRCLE,                TREE,   76,   78,    1,    0,    0},
        {    CIRCLE,                TREE,   88,   73,    1,    0,    0},
        {    CIRCLE,                TREE,   28,   43,    1,    0,    0},
        {    CIRCLE,                TREE,   67,   68,    1,    0,    0},
        {    CIRCLE,                TREE,   66,   95,    1,    0,    0},
        {    CIRCLE,                TREE,   12,   78,    1,    0,    0},
        {    CIRCLE,                TREE,   41,   71,    1,    0,    0},
        {    CIRCLE,                TREE,   28,   11,    1,    0,    0},
        {    CIRCLE,                TREE,   72,   39,    1,    0,    0},
        {    CIRCLE,                TREE,   30,   60,    1,    0,    0},
        {    CIRCLE,                TREE,   90,   46,    1,    0,    0},
        {    CIRCLE,                TREE,   83,    5,    1,    0,    0},
        {    CIRCLE,                TREE,   39,   23,    1,    0,    0},
        {    CIRCLE,                TREE,   50,   86,    1,    0,    0},
        {    CIRCLE,                TREE,   69,    2,    1,    0,    0},
        {    CIRCLE,                TREE,   83,   86,    1,    0,    0},
        {    CIRCLE,                TREE,   61,    8,    1,    0,    0},
        {    CIRCLE,                TREE,   57,   67,    1,    0,    0},
        {    CIRCLE,                TREE,   34,   49,    1,    0,    0},
        {    CIRCLE,                TREE,   67,   42,    1,    0,    0},
        {    CIRCLE,                TREE,   71,   57,    1,    0,    0},
        {    CIRCLE,                TREE,   88,   12,    1,    0,    0},
        {    CIRCLE,                TREE,   72,   67,    1,    0,    0},
        {    CIRCLE,                TREE,    2,   60,    1,    0,    0},
        {    CIRCLE,                TREE,   67,    6,    1,    0,    0},
        {    CIRCLE,                TREE,   44,    6,    1,    0,    0},
        {    CIRCLE,                TREE,   44,   15,    1,    0,    0},
        {    CIRCLE,                TREE,   12,    2,    1,    0,    0},
        {    CIRCLE,                TREE,   81,   44,    1,    0,    0},
        {    CIRCLE,                TREE,   32,   83,    1,    0,    0},
        {    CIRCLE,                TREE,   25,   61,    1,    0,    0},
        {    CIRCLE,                TREE,   34,   52,    1,    0,    0},
        {    CIRCLE,                TREE,   38,   86,    1,    0,    0},
        {    CIRCLE,                TREE,   55,   10,    1,    0,    0},
        {    CIRCLE,                TREE,   56,   91,    1,    0,    0},
        {    CIRCLE,                TREE,   40,   11,    1,    0,    0},
        {    CIRCLE,                TREE,   40,   52,    1,    0,    0},
        {    CIRCLE,                TREE,   52,   14,    1,    0,    0},
        {    CIRCLE,                TREE,   66,   56,    1,    0,    0},
        {    CIRCLE,                TREE,   72,   77,    1,    0,    0},
        {    CIRCLE,                TREE,   40,   84,    1,    0,    0},
        {    CIRCLE,                TREE,   83,   92,    1,    0,    0},
        {    CIRCLE,                TREE,   13,   99,    1,    0,    0},
        {    CIRCLE,                TREE,    6,   51,    1,    0,    0},
        {    CIRCLE,                TREE,    8,   27,    1,    0,    0},
        {    CIRCLE,                TREE,   17,   10,    1,    0,    0},
        {    CIRCLE,                TREE,   32,   51,    1,    0,    0},
        {    CIRCLE,                TREE,   32,   58,    1,    0,    0},
        {    CIRCLE,                TREE,    1,   76,    1,    0,    0},
        {    CIRCLE,                TREE,   53,    8,    1,    0,    0},
        {    CIRCLE,                TREE,   10,   66,    1,    0,    0},
        {    CIRCLE,                TREE,   15,   52,    1,    0,    0},
        {    CIRCLE,                TREE,   63,   17,    1,    0,    0},
        {    CIRCLE,                TREE,   86,   94,    1,    0,    0},
        {    CIRCLE,                TREE,   97,   59,    1,    0,    0},
        {    CIRCLE,                TREE,   57,   44,    1,    0,    0},
        {    CIRCLE,                TREE,   55,   66,    1,    0,    0},
        {    CIRCLE,                TREE,   52,   45,    1,    0,    0},
        {    CIRCLE,                TREE,   33,   84,    1,    0,    0},
        {    CIRCLE,                TREE,   43,   53,    1,    0,    0},
        {    CIRCLE,                TREE,   49,   55,    1,    0,    0},
        {    CIRCLE,                TREE,    7,   68,    1,    0,    0},
        {    CIRCLE,                TREE,   89,   37,    1,    0,    0},
        {    CIRCLE,                TREE,    6,   24,    1,    0,    0},
        {    CIRCLE,                TREE,    3,    9,    1,    0,    0},
        {    CIRCLE,                TREE,   75,   90,    1,    0,    0},
        {    CIRCLE,                TREE,   39,   41,    1,    0,    0},
        {    CIRCLE,                TREE,   31,    2,    1,    0,    0},
        {    CIRCLE,                TREE,   82,   25,    1,    0,    0},
        {    CIRCLE,                TREE,   64,   86,    1,    0,    0},
        {    CIRCLE,                TREE,   74,   14,    1,    0,    0},
        {    CIRCLE,                TREE,   77,   22,    1,    0,    0},
        {    CIRCLE,                TREE,   75,   33,    1,    0,    0},
        {    CIRCLE,                TREE,   77,   45,    1,    0,    0},
        {    CIRCLE,                TREE,   98,   11,    1,    0,    0},
        {    CIRCLE,                TREE,   96,   24,    1,    0,    0},
        {    CIRCLE,                TREE,   95,   35,    1,    0,    0},
    },    // forest
};
