...
Multiprocess::Multiprocess(int playerCount, long usedCoreNumber) : m_playerCount(playerCount), m_usedCoreNumber(usedCoreNumber)
{
...
void Multiprocess::NotifyOneFinish(pid_t pid)
{
...
void Multiprocess::SendDemand()
{
    // write(m_processInfo[m_playerID].receiver[1], &d, sizeof(d));
}

void Multiprocess::Register(int playerID, aiFunc pfunc)
{
